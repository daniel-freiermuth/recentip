...
//! # Test Organization
//!
//! Tests are organized by spec document:
//! - `rpc`: RECENT/IP RPC protocol (someip-rpc.rst)  
//! - `sd`: Service Discovery (someip-sd.rst)
//!
//! # Requirement Traceability
//!
//! Each test documents which requirement(s) it covers.
...
mod rpc {
    ...
    mod semantics {
        ...
        fn fire_and_forget_returns_nothing() {
            ...
            covers!(feat_req_recentip_15); // Definition of F&F
        }
        ...
        fn responder_must_be_consumed() {
            ...
            covers!(feat_req_recentip_15); // Definition of Request/Response
        }
    }
}
